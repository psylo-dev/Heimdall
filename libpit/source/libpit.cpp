...
{
    entryCount = 0;
    unknown1 = unknown2 = unknown3 = unknown4 = unknown5 = unknown6 = unknown7 = unknown8 = 0;
}

PitData::~PitData()
{
    // Richtiges Löschen der Einträge
...
bool PitData::Unpack(const unsigned char *data)
{
    ...
    entries.resize(entryCount); // Sicherstellen, dass der Vektor die richtige Größe hat
    ...
    for (unsigned int i = 0; i < entryCount; i++)
    {
        ...
        // Neue Einträge korrekt zuweisen
